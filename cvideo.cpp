...
//                  Decreased RAM usage by updating the image buffer scanline on
//                  the fly during the horizontal interrupt
//					Fixed logic error in cvideo_dma_handler;
// initial memcpy done twice
// 31/01/2022:      Refactored to use less memory
//					Split the video generation into two
// state machines; sync and data
...
// 20/02/2022:      Bitmap is now dynamically allocated; added two higher
 ...
 * of the 64us horizontal sync. The value 0x00 is reserved as a control byte for
 * the horizontal sync; cvideo_sync will not write to the GPIO for that block of
 * 0x00's.
 *
...
// - transfer_size: Size of each DMA bus transfer (DMA_SIZE_8, DMA_SIZE_16 or
// DMA_SIZE_32)
