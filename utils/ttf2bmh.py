...
def main():
    ...
    parser.add_argument('-s','--fontsize', default='32', choices=['8', '10','12', '16', '24', '32', '40', '48', '56', '64', 'all'], help='Fontsize (Fontheight) in pixels. Default: 32')
    ...
    if len(sys.argv) == 1:
        ...
        TTF_FILES = [
            {'dir': "/usr/share/fonts/TTF/", 'filename':'FSEX302.ttf'}
        ]

        # Definition of Font Heights and offsets
        font_heights  = [8,10,12, 16, 24, 32, 40, 48, 56, 64]
        font_yoffsets = [0,2, 3 , 3 , 6 , 5 , 7 , 8 , 9 , 10]
